...
class jobAd(models.Model):
	...
	#employer = models.ForeignKey(employers, on_delete=models.CASCADE, help_text="Foreign key to Employer table")
...
class employer(models.Model):
		...
		emplo_comname = models.CharField(max_length=100, help_text="Company Name")
