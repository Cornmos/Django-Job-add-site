...
urlpatterns = [
	...
	path('employee/update_emp_form/<int:id>', views.update_emp_form, name = 'UpdateEmployee'),
    ...
    re_path(r'^AppliedAplicants2/?$',views.load_AppliedAplicants2,name='AppliedAplicants2'),
